...
public class RxModule : BaseModule, IModuleNode
{
    public int CapturedLowPulses { get; private set; } = 0;
    public int CapturedHighPulses { get; private set; } = 0;

    public bool CapturedSingleLowPulse => CapturedLowPulses == 1 && CapturedHighPulses == 0;

    public RxModule(ModuleConfiguration config) : base (config, "rx", new List<string>())
    {
    }
